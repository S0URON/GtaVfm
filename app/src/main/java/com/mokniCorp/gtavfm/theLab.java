...
public class theLab extends AppCompatActivity {
    ...
    private BottomNavigationView.OnNavigationItemSelectedListener mOnNavigationItemSelectedListener
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            if (item.getItemId() == R.id.navigation_dashboard ) {
                mp.pause();
                Intent move = new Intent(theLab.this, RadioList.class);
                startActivity(move);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_the_lab);
        BottomNavigationView navView = findViewById(R.id.nav_view);
        navView.setOnNavigationItemSelectedListener(mOnNavigationItemSelectedListener);

        play = findViewById(R.id.playBTN);
        Vol = findViewById(R.id.VolBar);
        mp = MediaPlayer.create(this,  R.raw.thelabradio);
